...
$html .= "<tr>\n";
$html .= "<th>Number of tables</th><td>".count($structuresPerTable)."</td>\n";
$html .= "</tr>\n";
$html .= "</tbody>\n";
$html .= "</table>\n";
$html .= "</div>\n";
...
$menus .= '<button type="button" id="menu_database_info" class="menu-button" onclick="refreshTableSection(\'database_info\');">'.h($config->db->name).'</button><br>';

$menus .= '<strong>Tables</strong><br>';
foreach ($structuresPerTable as $tableName => $structures) {
    $menus .= '<button type="button" id="menu_table_'.h($tableName).'" class="menu-button" onclick="refreshTableSection(\'table_'.h($tableName).'\');">'.h($tableName).'</button><br>';
}
$menus .= '<div class="copyright">Generated By <a href="https://github.com/hoku/quickt-db-teigi" target="_blank">QuicktDBTeigi</a>.</div>';
$menus .= '</div>';
...
function refreshTableSection(targetId) {
    document.querySelectorAll(".menu-button").forEach(function(value) {
        value.style.backgroundColor = "transparent";
        value.style.color = "#222";
    });
    document.getElementById("menu_" + targetId).style.backgroundColor = "rgb(168 31 124)";
    document.getElementById("menu_" + targetId).style.color = "white";
...
refreshTableSection("database_info");
</script>
</html>';
